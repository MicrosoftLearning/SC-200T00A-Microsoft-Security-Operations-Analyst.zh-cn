...
在此任务中，你将在 Microsoft Sentinel 中创建关注列表。
...
1. 从 Microsoft Azure“痕迹导航”菜单中，选择“**主页**”。

1. 门户的“Azure 服务”部分中应显示“Microsoft Sentinel”磁贴。****** 选择它。

1. 选择“defenderWorkspace”**** 这个 Microsoft Sentinel 工作区。
...
1. 选择“上传文件”下的“浏览文件”，然后浏览已创建的 HighValue.csv 文件。********
...
1. 从“*对象类型*”下拉列表中，选择“**指示器**”。

1. 选择“**+ 新建可观察对象**”下拉列表，然后选择“**域名**”。

1. 对于“域”，请输入域名，例如键入 contoso.com。

1. 在“名称”字段中，输入用于域的同一值。****

1. 在“*指示器类型*”中，选择“**恶意活动**”。

1. 将“有效期开始时间”字段设置为当天日期。

1. 向下滚动到“**说明**”，并输入“*此域已知为恶意*”。

1. 选择 **添加** 。

1. 在“*Sentinel*”导航菜单的“*常规*”区域下选择“**日志**”选项。 你可能希望禁用“始终显示查询”选项，并关闭“查询”窗口以运行 KQL 语句。
...
1. 搜索并选择“**SecurityEvent**”表，然后选择省略号链接 (...)。
...
1. 将“*总保留期*”重置为“**180 天**”（如果需要）。 请注意，“存档期”已设置为“90 天”，因为 Azure Monitor 会自动将 90 天剩余总保留期视为低成本的长期保留期。******
