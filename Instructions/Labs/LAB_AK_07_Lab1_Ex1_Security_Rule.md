...
1. 单击“规则模板”。 搜索并选择“基于 Microsoft Defender for Cloud 创建事件”。

1. 此规则是由“模块 6 - 练习 1 - 任务 4”中配置的 Defender for Cloud 连接器激活的。
...
1. 选择底部的自动响应”按钮，然后选择“下一步:审阅”按钮。 查看所做的更改并选择“保存”按钮。

## <a name="proceed-to-exercise-2"></a>分析规则会保存。
