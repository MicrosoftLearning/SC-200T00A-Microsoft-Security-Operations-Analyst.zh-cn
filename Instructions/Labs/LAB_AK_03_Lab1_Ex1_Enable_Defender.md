...
1. 选择“访问控制(IAM)”，然后在右窗格中选择“添加角色分配” 。

1. 选择“特权管理员角色”选项卡，然后选择“所有者” 。 选择“下一步”继续操作。

1. 在“成员”选项卡下，单击“选择成员”，选择“MOD 管理员”帐户，然后单击“选择”以继续  。
...
1. 选择“下一步”，直到出现“代理设置选项”的向导页面 。

1. 选择“将代理连接到 Azure Log Analytics (OMS)”，然后选择“下一步” 。
